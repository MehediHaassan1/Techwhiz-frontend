    ...
    <AnimatePresence>
      {profileCollapse && (
        <motion.div
          ...
          className="fixed z-10 min-h-7h-screen  overflow-y-auto w-full md:w-2/3 lg:w-1/2 top-16 lg:top-0 right-0 bottom-0 bg-black p-8 md:py-4"
          exit={{ x: "20%", opacity: 1 }}
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="flex-1 space-y-2 text-center md:text-left">
                      ...
                      <div className="flex flex-wrap justify-center md:justify-start gap-2">
                        <Chip variant="solid">{user?.role}</Chip>
                        <Chip
                          color={
                        ...
                        <Chip
                          variant={
                            user?.subscription === "free" ? "faded" : undefined
                          }
                        >
                          {user?.subscription}
                        </Chip>
                        ...
                        {user?.isDeleted && <Chip color="danger">Deleted</Chip>}
                      </div>
                    </div>
                  </div>
                </CardHeader>
